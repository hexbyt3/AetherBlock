/**
 * @file input.c
 * @brief Controller input polling with key-repeat support.
 *
 * Wraps libnx pad input and translates button presses into InputEvent
 * values. Supports initial delay and repeat rate for held buttons.
 */
...
/**
 * @brief Initialize the controller input system.
 */
void inputInit(void) {
...
/**
 * @brief Poll the controller and fill the InputState with events for this frame.
 * @param state  InputState to populate with any button events.
 */
